    ...
    public class LayoutAwarePage : Page
    {
        ...
        public LayoutAwarePage()
        {
            ...
            this.Loaded += (sender, e) =>
            {
                ...
                #region Contrato de Settings (configuração) - Registra o evento
                SettingsPane.GetForCurrentView().CommandsRequested += AppBox_CommandsRequested;
                #endregion
            };
            ...
            this.Unloaded += (sender, e) =>
            {
                ...
                #region Contrato de Settings (configuração)  - Remove o registro do evento.
                SettingsPane.GetForCurrentView().CommandsRequested -= AppBox_CommandsRequested;
                #endregion
            };
        }
        ...
        #region Contrato de Settings (configuração)
        /// <summary>
        ...
        /// <summary>
        /// Método que será executado quando o usuário clicar na opção Sobre no painel de settings.
        /// </summary>
        /// <param name="command"></param>
        void onSettingsCommand(IUICommand command)
        {
            UIElement controle = null;
            ...
            if (controle != null)
            {
                Flyout f = new Flyout(
                        ...
                        new SolidColorBrush(Colors.Black), //new SolidColorBrush(ColorHelper.FromArgb(255, 113, 177, 209)),
                        title,
                        FlyoutDimension.Medium,
                        controle);
        ...
        void f_OnClosing(object sender, CloseReason reason)
        {
